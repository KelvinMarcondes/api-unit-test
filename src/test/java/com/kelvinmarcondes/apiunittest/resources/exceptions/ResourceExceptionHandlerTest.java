package com.kelvinmarcondes.apiunittest.resources.exceptions;

import com.kelvinmarcondes.apiunittest.services.exceptions.DataIntegrityViolationException;
...
class ResourceExceptionHandlerTest {
    ...
    void dataIntegrityViolation() {
        ResponseEntity<StandardError> response = exceptionHandler.dataIntegrityViolation
                (new DataIntegrityViolationException(EMAIL_JA_CADASTRADO_NO_SISTEMA), new MockHttpServletRequest());
